...
{{- default .Chart.Name .Values.certIssuer.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- if .Values.certIssuer.fullnameOverride }}
{{- .Values.certIssuer.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.certIssuer.nameOverride }}
